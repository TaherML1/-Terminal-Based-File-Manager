...
void handle_command(char *line) {
    ...
    if (strcmp(argv[0], "help") == 0) {
        ...
        if (argc != 2) {
            printf(RED "Error: Missing directory parameter for 'tlist' command.\n" RESET);
            print_usage();
            return;
        }
        ...
        if (argc != 3) {
            printf(RED "Error: Missing source or destination parameter for 'tcopy' command.\n" RESET);
            print_usage();
            return;
        }
        ...
        if (argc != 2) {
            printf(RED "Error: Missing file/directory parameter for 'tremove' command.\n" RESET);
            print_usage();
            return;
        }
        ...
        if (argc != 2) {
            printf(RED "Error: Missing directory parameter for 'tcreate' command.\n" RESET);
            print_usage();
            return;
        }
        ...
        if (argc != 2) {
            printf(RED "Error: Missing filename parameter for 'tcreatefile' command.\n" RESET);
            print_usage();
            return;
        }
        create_file(argv[1]);
        ...
        if (argc != 3) {
            printf(RED "Error: Missing file/directory or permissions parameter for 'tchmod' command.\n" RESET);
            print_usage();
            return;
        }
        ...
        if (argc != 3) {
            printf(RED "Error: Missing filename or data parameter for 'twrite' command.\n" RESET);
            print_usage();
            return;
        }
        ...
        if (argc != 2) {
            printf(RED "Error: Missing filename parameter for 'tread' command.\n" RESET);
            print_usage();
            return;
        }
        ...
        if (argc != 2) {
            printf(RED "Error: Missing directory parameter for 'topen' command.\n" RESET);
            print_usage();
            return;
        }
        open_folder(argv[1]);
        ...
        if (argc != 2) {
            printf(RED "Error: Missing filename parameter for 'tinfo' command.\n" RESET);
            print_usage();
            return;
        }
        ...
        if (argc != 2) {
            printf(RED "Error: Missing filename parameter for 'tedit' command.\n" RESET);
            print_usage();
            return;
        }
        edit_file(argv[1]);
        ...
        if (argc != 3) {
            printf(RED "Error: Missing oldname or newname parameter for 'trename' command.\n" RESET);
            print_usage();
            return;
        }
